...
interface ISquidBetSecondRound {
    /// interface of SquidBet second Round contract
...
contract SquidBetThirdRound is CustomAdmin, ReentrancyGuard {
    ISquidBetSecondRound private tokenContract;
    enum Side {
        Biden,
        Trump
    }
    ...
    constructor(address _prizePool, ISquidBetSecondRound _tokenContract) {
